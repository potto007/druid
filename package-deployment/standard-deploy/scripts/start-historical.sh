...
HISTORICAL_JAVA_OPTS="-Xms50g -Xmx50g -XX:NewSize=6g -XX:MaxNewSize=6g -XX:MaxDirectMemorySize=32g -XX:+UseConcMarkSweepGC"
...
java $COMMON_JAVA_PROPS $HISTORICAL_JAVA_OPTS -cp $CP $HISTORICAL_JAVA_PROPS io.druid.cli.Main server historical