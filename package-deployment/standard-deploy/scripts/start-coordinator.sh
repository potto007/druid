...
COORDINATOR_JAVA_OPTS="-Xms10g -Xmx10g -XX:NewSize=512m -XX:MaxNewSize=512m -XX:+UseConcMarkSweepGC"
...
java $COMMON_JAVA_PROPS $COORDINATOR_JAVA_OPTS -cp $CP $COORDINATOR_JAVA_PROPS io.druid.cli.Main server coordinator